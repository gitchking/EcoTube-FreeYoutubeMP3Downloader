          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <Label className="block text-lg font-bold text-forest-700 mb-3 font-comic">
                <User className="text-comic-orange mr-2 inline" size={20} />
                Your Name
              </Label>
              <Input 
                type="text" 
            ...
            >
              <Label className="block text-lg font-bold text-forest-700 mb-3 font-comic">
                <Mail className="text-comic-orange mr-2 inline" size={20} />
                Email Address
              </Label>
              <Input 
                type="email" 
            ...
            >
              <Label className="block text-lg font-bold text-forest-700 mb-3 font-comic">
                <MessageCircle className="text-comic-orange mr-2 inline" size={20} />
                Your Message
              </Label>
              <Textarea 
                rows={6} 
