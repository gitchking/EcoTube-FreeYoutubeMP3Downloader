...
export default function Terms() {
  ...
  return (
    <section className="py-12 bg-ocean-100">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-forest-700 mb-4 font-comic">Terms of Service</h2>
          <p className="text-xl text-forest-600 font-nunito">Simple, fair terms for using our eco-friendly conversion service.</p>
